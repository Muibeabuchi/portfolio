...
const services = [
  {
    icon: <BsBraces size={30} className="mb-6 text-zinc-300" />,
    title: "Full Stack Developer",
    description:
      "I Architect Engaging Fullstack Applications and Solutions using Backend Services and CMS (Supabase,Payload CMS)",
